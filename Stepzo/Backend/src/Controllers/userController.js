      ...
      html: `<!DOCTYPE html>
        ...
        <body>
            ...
            <div class="content">
                ...
                <div class="about">
                    <p>Welcome to Setpzo - Designed for your feet. Styled for your life.</p>
                    <p>Our store is dedicated to providing premium footwear that blends comfort, durability, and modern style. We believe in elevating every step with shoes that deliver both performance and aesthetics.</p>
                    <p>Each pair in our collection is carefully selected to offer exceptional comfort, long-lasting quality, and timeless style.</p>
                </div>
                ...
                <div class="footer">
                    <p>© ${new Date().getFullYear()} Stepzo. All Rights Reserved.</p>
                </div>
            </div>
        </body>
        </html>`,
...
const forgotPassword = async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: '"Stepzo" <www.smdaffan5.www@gmail.com>',
      to: email,
      subject: "Reset Your Password - Stepzo",
      html: `<!DOCTYPE html>
    <html>
    <head>
        <style>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="about">
                <p>We received a request to reset the password for your Stepzo account.</p>
